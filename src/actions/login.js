...
export const recievedHomePage = data => ({
  ...
  export const fetchHomePage = () => {
    ...
    return dispatch => {
      ...
      axios.get(LOGIN_CONSTANTS.HOME_CONSTANTS.URL,
  ...
  return dispatch => {
    ...
    axios.post(LOGIN_CONSTANTS.TOKEN_CONTANTS.URL,JSON.stringify(data),
    {  
        headers: 
        {
...
export const recievedCustomerDetailsPage = data => ({
  ...
  export const fetchCustomerDetails = (data) => {
    ...
    return dispatch => {
      ...
      axios.get(LOGIN_CONSTANTS.CUSTOMER_DETAILS_CONTANTS.URL,
        {  
            headers: 
            {
                'Content-Type': 'application/json',
