...
export const requestCartItemsByCustomerDetails = () => ({
    ...
    export const fetchCartItemsByCustomer = (data) => {
      ...
      return dispatch => {
        ...
        axios.get(CART_CONSTANTS.CART_ITEMS_BY_CUSTOMER,
          {  
              headers: 
              {
    ...
    export const requestQuoteIdDetails = () => ({
        ...
        export const fetchQuoteId = (data) => {
          ...
          return dispatch => {
            ...
            axios.post(CART_CONSTANTS.QUOTE_URL,
              {  
                  headers: 
                  {
                      'Content-Type': 'application/json',
    ...
    export const requestAddToCart = () => ({
        ...
        export const postAddToCartData = (data,data1) => {
          ...
          return dispatch => {
            ...
            axios.post(CART_CONSTANTS.ADD_TO_CART_URL,JSON.stringify(data),
              {  
                  headers: 
                  {
                      'Content-Type': 'application/json',
...
export const requestUpdateToCart = () => ({
    ...
    export const fetchUpdateCartData = (data, data1,data2) => {
      ...
      return dispatch => {
        ...
        axios.put(CART_CONSTANTS.UPDATE_CART_URL_CONSTANTS.URL+data2,JSON.stringify(data),
          {  
              headers: 
              {
                  'Content-Type': 'application/json',
    ...
    export const requestGrandTotal = () => ({
      ...
      export const fetchGrandTotal = (data, data1) => {
          console.log(data);
          console.log(data1);
          var url = CART_CONSTANTS.SETTING_BILLING_AND_SHIPPING.URL+data+'/shipping-information'; 
        return dispatch => {
          dispatch(requestGrandTotal());
          axios.post(url,JSON.stringify(data1),
            {  
                headers: 
                {
                    'Content-Type': 'application/json',
              ...
              export const requestGetCartData = () => ({
                ...
                export const postGuestAddToCartData = (data) => {
                  ...
                  return dispatch => {
                    ...
                    axios.post(CART_CONSTANTS.GUEST_ADD_TO_CART_URL,JSON.stringify(data),
                      {  
                          headers: 
                          {
                              'Content-Type': 'application/json',
                ...
                export const updateGuestCartData = (data,data1) => {
                  ...
                  return dispatch => {
                    ...
                    axios.put(CART_CONSTANTS.GUEST_EDIT_TO_CART_URL+data1,JSON.stringify(data),
                      {  
                          headers: 
                          {
                              'Content-Type': 'application/json',
                ...
                export const deleteGuestCartData = (data) => {
                  ...
                  return dispatch => {
                    ...
                    axios.delete(CART_CONSTANTS.GUEST_DELETE_TO_CART_URL+data,
                      {  
                          headers: 
                          {
                              'Content-Type': 'application/json',
                ...
                export const getGuestCartList = (data) => {
                  ...
                  return dispatch => {
                    ...
                    axios.get(CART_CONSTANTS.GUEST_CART_LIST_URL+data,
                      {  
                          headers: 
                          {
                              'Content-Type': 'application/json',
                ...
                export const getGuestConvertCartList = (data,data1) => {
                  ...
                  return dispatch => {
                    ...
                    axios.post(CART_CONSTANTS.GUEST_CONVERT_URL,JSON.stringify(data),
                      {  
                          headers: 
                          {
                              'Content-Type': 'application/json',
                ...
                export const getGiftMessage = (data) => {
                  ...
                  return dispatch => {
                    ...
                    axios.post(CART_CONSTANTS.GIFT_MESSAGE,JSON.stringify(data),
                      {  
                          headers: 
                          {
                              'Content-Type': 'application/json',
