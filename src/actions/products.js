...
export const recievedRelatedProducts = data => ({
  ...
  export const fetchRelatedProducts = (data) => {
      console.log(data);
    return dispatch => {
        axios.get(PRODUCT_CONSTANTS.RELATED_PRODUCTS_URL+data,
        {  
            headers: 
            {
  ...
  export const fetchSlot = (data) => {
      console.log(data);
    return dispatch => {
      axios.post('https://uat.mediversal.tech/index.php/api/product/timeslots?'+qs.stringify(data))
...
export const requestProductDetails = () => ({
  ...
  export const fetchProductDetails = (data) => {
    ...
    return dispatch => {
      ...
      axios.get(PRODUCT_CONSTANTS.PRODUCTS_DETAIL_URL+'?searchCriteria[filter_groups][0][filters][0][field]=sku&searchCriteria[filter_groups][0][filters][0][value]='+data+'&searchCriteria[filter_groups][0][filters][0][condition_type]=eq',
        {  
            headers: 
            {
                'Content-Type': 'application/json',
...
export const recievedUpsellDetails = data => ({
  ...
  export const fetchUpsellingProducts = (data) => {
    ...
    return dispatch => {     
        axios.get(PRODUCT_CONSTANTS.UPSELL_PRODUCTS_URL+data,
        {  
            headers: 
            {
                'Content-Type': 'application/json',
  ...
  return dispatch => {
    ...
    axios.post(PRODUCT_CONSTANTS.PRODUCTS_REVIEW_URL,JSON.stringify(data),
    {  
        headers: 
        {
            'Content-Type': 'application/json',
  ...
  export const fetchProductDates = (data,data1) => {
    ...
    var url=PRODUCT_CONSTANTS.GET_PRODUCT_DATES.URL+data+'?zip_code='+data1;
    console.log(url);
  return dispatch => {
  ...
  return dispatch => {
    ...
    axios.get(PRODUCT_CONSTANTS.PRODUCTS_REVIEW_DATA_URL+'?searchCriteria[filter_groups][0][filters][0][field]=entity_pk_value&searchCriteria[filter_groups][0][filters][0][value]='+data+'&searchCriteria[filter_groups][0][filters][0][condition_type]=eq',
    {  
        headers: 
        {
            'Content-Type': 'application/json',
