            ...
            case LOGIN_CONSTANTS.HOME_CONSTANTS.RECEIVED:
                return Object.assign({}, state, {
                   ...
                   // homePageData: action.data[0].homePageData[0].response.categoryList.home_page_block,
                    ...
                    bannerWeb: action.data[0].response.categoryList.home_page_block[0].home_slider_block.gallery_images,
                    bannerMobile: action.data[0].response.categoryList.home_page_block[0].home_slider_block.mobile_gallery_images,
                    ...
                    featuredProducts: action.data[0].response.categoryList.home_page_block[4],
                    lastUpdated: action.receivedAt,
                });
