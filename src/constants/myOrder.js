// My Order Constants
export const MY_ORDER_URL = `${process.env.APPLICATION_BFF_URL}/rest/arabella/V1/orders`;
...
export const ORDER_ID_URL = `${process.env.APPLICATION_BFF_URL}/rest/default/V1/orders`;
